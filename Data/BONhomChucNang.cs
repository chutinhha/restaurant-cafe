...
namespace Data
{
    public class BONhomChucNang
    {
        ...
        public BONhomChucNang(Transit transit)
        {
            ...
            BanHang.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.BaoCaoLichSuBanHang, TenChucNang = "Báo cáo lịch sử bán hàng", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
            BanHang.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.BaoCaoNhanVien, TenChucNang = "Báo cáo nhân viên", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
            BanHang.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.LichSuDangNhap, TenChucNang = "Báo cáo lịch sử đăng nhập", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
            BanHang.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.LichSuInNhaBep, TenChucNang = "Báo cáo lịch sử in nhà bếp", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
            BanHang.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.BaoCaoThuChi, TenChucNang = "Báo cáo thu chi", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
