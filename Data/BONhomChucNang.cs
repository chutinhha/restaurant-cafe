...
namespace Data
{
    public class BONhomChucNang
    {
        ...
        public BONhomChucNang(Transit transit)
        {
            ...
            BaoCao.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.BaoCaoBan, TenChucNang = "Báo cáo bàn", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
            BaoCao.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.BaoCaoKhu, TenChucNang = "Báo cáo khu", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
