...
namespace PrintServer
{
    public class Ean13
    {
        ...
        private float _fWidth = 160.0f;

        //private float _fHeight = 25.93f;
        //private float _fHeight = 60.0f;
        private float _fHeight = 40.0f;
        ...
        public Ean13(string mfgNumber, string productId)
        {
            ...
            this.Barcode = this.CountryCode + this.ManufacturerCode + this.ProductCode;
        ...
        public System.Drawing.Bitmap CreateBitmap()
        {
            ...
            //System.Drawing.Bitmap bmp = new System.Drawing.Bitmap((int)(this.Width),(int)(this.Height));
