...
namespace Data
{
	public class BONhomChucNang
	{
		...
		public BONhomChucNang(Transit transit)
		{
			...
			BaoCao.CHUCNANGs.Add(new CHUCNANG() { ChucNangID = (int)TypeChucNang.Baocao.BaoCaoTonKho, TenChucNang = "Báo cáo tồn kho", NhomChucNangID = BaoCao.NhomChucNangID, ChoPhep = true, DangNhap = true, Them = false, Xoa = false, Sua = false, Visual = true, Deleted = false, Edit = false });
